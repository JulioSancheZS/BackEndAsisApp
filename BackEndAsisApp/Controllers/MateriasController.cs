...
namespace BackEndAsisApp.Controllers
{
    public class MateriasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdMateria,NomMateria")] Materia materia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdMateria,NomMateria")] Materia materia)
        {
            if (ModelState.IsValid)
            {
